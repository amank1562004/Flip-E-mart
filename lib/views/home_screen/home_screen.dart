...
import 'package:flip_app/views/home_screen/components/featured_button.dart';
import 'package:flip_app/widgets_common/home_buttons.dart';
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                //  all products
                  ...
                  Align(
                    alignment: Alignment.bottomLeft,
                    child: allProduct.text.color(darkFontGrey).size(18).fontFamily(bold).make(),
                  ),
                  20.heightBox,
                  GridView.builder(
